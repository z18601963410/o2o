...
function optFormater(value, row, index) {
	...
	var shopCategoryId = row.shopCategory.shopCategoryId
...
function shopManagementEdit() {
	...
	shop.shopCategory.shopCategoryId = encodeURIComponent($(
...
function showcategory(val, row, index){
    if(row.shopCategory){  
        return row.shopCategory.shopCategoryId;  
    } 
}
